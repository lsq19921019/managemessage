 	...
 	<div>
 		...
 		<el-row >
			<el-col :span = "18"  class = 'mgb20'>
 				<el-col :span = "4" class = 'line-ht40-center'>URL跳转地址：</el-col>
 				<el-col :span = "20">
 					<el-input v-model = "link_url"></el-input>
 				</el-col> 				
 			</el-col>
      <el-col :span = "18"  class = 'mgb20'>
 				<el-col :span = "4" class = 'line-ht40-center'>小程序APPID：</el-col>
 				<el-col :span = "20">
 					<el-input v-model = "miniAppId"></el-input>
 				</el-col> 				
 			</el-col>
      <el-col :span = "18"  class = 'mgb20'>
 				<el-col :span = "4" class = 'line-ht40-center'>小程序路径：</el-col>
 				<el-col :span = "20">
 					<el-input v-model = "miniPagePath"></el-input>
 				</el-col> 				
 			</el-col>
  ...
  methods: {
    ...
    tidyPostData() {
      ...
      post_data = JSON.stringify({
        ...
        miniAppId: self.miniAppId.toString(),
        miniPagePath: self.miniPagePath.toString(),
